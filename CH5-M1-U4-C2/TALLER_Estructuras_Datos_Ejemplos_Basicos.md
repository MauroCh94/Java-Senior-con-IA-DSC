# Taller: Uso básico de cada estructura de datos

En este taller se propone **un ejemplo muy sencillo** por cada tipo de colección. El objetivo es que practiques la elección y el uso de **List**, **Set** y **Map** con sus implementaciones más usadas.
